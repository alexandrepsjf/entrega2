...
<html>
    ...
    <body>
        ...
        <div class="center "><h3>Pesquisa de Funcionarios</h3></div>
            ...
            <tbody>
                <c:forEach items="${funcionarios}" var="funcionario">
                    <tr>
                        ...
                        <td ><a href="FrontController?action=PrepararEditarFuncionario&id=<c:out value='${funcionario.id}' /> " ><i class="material-icons right">edit</i></a></td>
                        <td ><a href="FrontController?action=ApagarFuncionario&id=<c:out value='${funcionario.id}' /> " ><i class="material-icons right">delete</i></a></td>
                    </tr>
                </c:forEach>
            </tbody> 
        </table>

        <form action="gravarFuncionario.jsp" method="POST" class="center">
