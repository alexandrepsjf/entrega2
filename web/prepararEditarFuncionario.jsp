...
<html>
    ...
    <body>
        ...
        <div class="center "><h3>Editar  Funcionario</h3></div>
        <form action="FrontController?action=EditarFuncionario" method="post">
            <table class=" highlight centered">            
                <thead>                  <tr> 
                        <th></th> <th>Código Funcionario</th>
                ...
                <tbody> 
                    <tr class="center-align">
                        <td></td>
                        <td class="col s1">
                            <input  type="text" name="textId" value="<c:out value='${funcionario.id}' />" readonly /> 
                        </td>
                        <td> 
                            <input value="<c:out value='${funcionario.nome}' />" type="text" name="textNome"/>
                        </td> <td></td>
                    </tr>
                </tbody> 
            </table>       
