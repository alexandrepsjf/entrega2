 ...
 * @author negro
 */
public class MudarEstadoProduzidoPedidoAction implements Action {
...
//        String estado=request.getParameter("estado");
        try {
            ...
            Logger.getLogger(MudarEstadoProduzidoPedidoAction.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
